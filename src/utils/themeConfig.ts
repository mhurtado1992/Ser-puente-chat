...
export const THEMES: Record<ExhibitionThemeId, ThemeStyles> = {
  deep_river: {
    id: "deep_river",
    name: "Río Profundo",
    subtitle: "Inmersión oscura nocturna y reflejos turquesa",
    containerBg: "bg-[#06080a]",
    headerBg: "bg-[#06080a]/90 backdrop-blur-md",
    headerBorder: "border-stone-800/80",
    textColor: "text-stone-200",
    textMuted: "text-stone-400",
    accentColor: "text-teal-400",
    accentBadge: "bg-stone-900/90 border-stone-800 text-teal-400",
    accentIconBg: "bg-teal-950/40",
    accentIconBorder: "border-teal-800/50",
    riverMessageBg: "bg-teal-950/30 border-teal-800/30 text-teal-50",
    userMessageBg: "bg-stone-800/70 border-stone-700/50 text-stone-100",
    inputContainerBg: "bg-[#06080a]/95 border-stone-800/80",
    inputBg: "bg-stone-900/80",
    inputBorder: "border-stone-800",
    waterGradient: "from-teal-950/20 to-transparent",
    isLight: false,
  },
  white_gallery: {
    id: "white_gallery",
    name: "Galería Blanca",
    subtitle: "Luz de museo, marfil y papel editorial",
    containerBg: "bg-[#f8f7f4]",
    headerBg: "bg-[#f8f7f4]/95 backdrop-blur-md",
    headerBorder: "border-stone-200/90",
    textColor: "text-stone-800",
    textMuted: "text-stone-500",
    accentColor: "text-teal-700",
    accentBadge: "bg-stone-100 border-stone-300 text-teal-800",
    accentIconBg: "bg-teal-50",
    accentIconBorder: "border-teal-200",
    riverMessageBg: "bg-white border-stone-200/90 text-stone-800 shadow-sm",
    userMessageBg: "bg-stone-100 border-stone-200 text-stone-900",
    inputContainerBg: "bg-[#f8f7f4]/95 border-stone-200",
    inputBg: "bg-white",
    inputBorder: "border-stone-300",
    waterGradient: "from-teal-100/30 to-transparent",
    isLight: true,
  },
  valdivian_forest: {
    id: "valdivian_forest",
...
export const DEFAULT_AESTHETICS: ExhibitionAesthetics = {
  theme: "deep_river",
  title: "Ser Puente",
  subtitle: "Voces y memorias del Río San Pedro",
  fontStyle: "serif",
  waterAnimation: "full",
};

const STORAGE_KEY = "exhibition_aesthetics_settings_v1";
